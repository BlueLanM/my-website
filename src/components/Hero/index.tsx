...
export function SocialLinks({ ...prop }) {
	...
	return (
		<animated.div className={styles.social__links} {...prop}>
			...
			<a href={socials.qq} target="_blank" rel="noreferrer">
				<Icon icon="ri:qq-line" />
			</a>
			<a href={socials.twitter} target="_blank" rel="noreferrer">
				<Icon icon="ri:twitter-line" />
			</a>
			<a href={socials.zhihu} target="_blank" rel="noreferrer">
				<Icon icon="ri:zhihu-line" />
			</a>
			<a href={socials.cloudmusic} target="_blank" rel="noreferrer">
				<Icon icon="ri:netease-cloud-music-fill" />
			</a>
			<a href={socials.steam} target="_blank" rel="noreferrer">
